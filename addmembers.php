...
<div id="main"><br>
  <div id="form-color">
	<form method="post" action="add_membcknd.php">
    ...
    <div class="form-group">
      <label for="gender">Gender</label>
                      ...
                      <input type="radio" id="demo-priority-low" checked value="M" name="gen">
                      <label for="demo-priority-low">Male</label>
                      </div>
                      <div class="field half">
                      <input type="radio" id="demo-priority-high" value="F" name="gen">
    ...
    <div class="form-group">
      <label for="problem">Oftenly affected by</label>
      <input type="text" class="form-control" id="prob" name="aff_by">
    </div>
    <div class="form-group-details">
      <label for="treatment">Under any Treatment</label>
      <input type="text" class="form-control" id="treatment" name="under_treat">
    </div><br>
    <div class="form-group-details">
    	<label for="text">Need assistance? call us Immediately +919123527819</label></div><br>
    <div class="form-group-details">
