<?php
 ...
 $con= mysql_connect("localhost", "root","");
      ...
      $password=$_POST['pass'];
      $en_cr=sha1($password);
      $query="select * from admin where username='".$username."' and password='".$en_cr."'";    
      }
      ...
      if($records!=0){
         // $rec=mysql_fetch_row($result);
          ...
          echo "<center><br><br><h2>Redirecting to Admin Panel &nbsp;" .$username. "<h3></center>";
          header( "refresh:1;url=Bootstrap%20Template/index.php" );
